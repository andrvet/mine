package binarytree.levelordertraversalpringeachlevelperline;

import java.util.LinkedList;
import java.util.Queue;

public class LevelOrderTraversalPerLine {
	...
	public static void main(String[] args) throws java.lang.Exception {
		...
		LevelOrderTraversalPerLine i = new LevelOrderTraversalPerLine();
		
		System.out.println(" Output by Naive Approach : ");
		i.levelOrderNaiveApproach(root);
		
		System.out.println(" Output by Better (with Queue) Approach : ");
		i.levelOrderQueue(root);
		
		System.out.println(" REVERSE Output by NAIVE Approach : ");
		i.reverseLevelOrderNaiveApproach(root);
