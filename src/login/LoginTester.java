...
//				   if (dbPwd.equals(requestPwd)) {
					    msg="1 SUCCESS  user found. pwd match. DBUser="+dbUser+" requestUser="+requestUser+" dbPwd="+dbPwd+" requestPwd="+requestPwd;
					    System.out.println(msg);
					    return msg;
//				   }
//				   else {
...
//				   }
				...
				//user not found
					System.out.println("3 user NOT found so far i="+i+" dbuser="+dbUser+" requestuser="+requestUser+" continue");
					i++;
					continue;// check next user in the list
					//and not
