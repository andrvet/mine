...
public class LoginTesterNew {
	...
	private static DBUser[] dbUsersArray = {new DBUser("aAa","p1"),new DBUser("bbb","p1"),new DBUser("ccc","p2")};
	private static RequestUser[] requestUsersArray = {new RequestUser("AaA","p1"),new RequestUser("BBB","p1"),new RequestUser("cc","p2")};
	...
	public static String run() {
		...
		int i=0;
		 if (dbUsersArray.length == 0) {
			 ...
			 for (DBUser dbUser:dbUsersArray) {
				if (dbUser.dbName.toLowerCase().equals(requestUser.toLowerCase())) {
					//user found
